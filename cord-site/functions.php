...
function bones_register_sidebars() {
	register_sidebar(array(
		...
		'after_widget' => '</div>',
		'before_title' => '<div class="moduleTitle"><h3><span>',
...
function bones_fonts() {
  wp_enqueue_style('googleFonts', 'http://fonts.googleapis.com/css?family=Chango&subset=latin,latin-ext');
}
